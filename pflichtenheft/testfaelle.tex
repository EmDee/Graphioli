...
Alice starts the Game-Explorer and adds a new game by using the \emph{Add}-function. Then Alice selects the game in the list in order to look at the screenshot and the description of the game. Still not convinced, Alice uses the help function to gain an insight in how the game works. Then Alice starts the game.

...
\begin{description}
   	\item[\textlabel{/FR130/}{FR:GE010}] \textbf{\textlabel{Manage Games}{FR:GET010}} \\
	Managing games that were implemented using the {\graphioli} framework is an easy task with the Game-Explorer. The Game-Explorer is the centerpiece for all games. It combines the games within one window and lets the player select a game to play. Every game is saved in a subfolder within the \emph{Game-Explorer} directory.
  	\item[\textlabel{/FR140/}{FR:GE020}] \textbf{\textlabel{Start games}{FR:GET020}} \\
	Once a game is selected in the menu, the player can start a game by pressing the \emph{Start} button. See \ref{REF:GAME-EXPLORER}.
  	\item[\textlabel{/FR150/}{FR:GE030}] \textbf{\textlabel{Help page}{FR:GET030}} \\
	...
	\item[\textlabel{/FR160/}{FR:GE040}] \textbf{\textlabel{Display description}{FR:GET040}} \\
	...
	\item[\textlabel{/FR170/}{FR:GE050}] \textbf{\textlabel{Add new games}{FR:GET050}} \\
...
\begin{description}
   ...
   \item[\textlabel{/FR210/}{FR:G040}] \textbf{\textlabel{Restart game}{FR:GT040}} \\
   ...
   \item[\textlabel{/FR220/}{FR:G050}] \textbf{\textlabel{Undo move}{FR:GT050}} \\
   ...
   \item[\textlabel{/FR230/}{FR:G060}] \textbf{\textlabel{Redo move}{FR:GT060}} \\
   ...
   \item[\textlabel{/FR240/}{FR:G070}] \textbf{\textlabel{Take screenshots}{FR:GT070}} \\

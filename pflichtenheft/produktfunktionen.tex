\newcommand{\graphioli}{\textsc{Graphioli Framework}} \todo{Should we use Graphioli or Graphioli Framework? Which other words should be emphasized?}
\newcommand{\gameexplorer}{{\sc Game-Explorer}}

...
\begin{description}
  	\item[\textlabel{/FR010/}{FR:010}] {\bf \textlabel{Add/Remove/Move nodes/edges}{FR:T010}}  \\
	...
	\item[\textlabel{/FR020/}{FR:020}] {\bf \textlabel{Nodes/Edges have attributes}{FR:T020}}  \\
	...
	\item[\textlabel{/FR030/}{FR:030}] {\bf \textlabel{Find shortest path}{FR:T030}}  \\
	The Graphioli framework implements algorithms to find the shortest path within a given graph.
	\item[\textlabel{/FR040/}{FR:040}] {\bf  \textlabel{Check for planarity}{FR:T040}}  \\
...
\begin{description}
  	\item[\textlabel{/FR090/}{FR:090}] {\bf \textlabel{Manage Games}{FR:T090}} \\
 	...
 	\item[\textlabel{/FR100/}{FR:100}] {\bf \textlabel{Start games}{FR:T100}}  \\
 	Once a game is selecting in the menu, the player can start a game by pressing the `Start' button.
	\item[\textlabel{/FR110/}{FR:110}] {\bf \textlabel{See game instructions}{FR:T110}}  \\
	...
	\item[\textlabel{/FR120/}{FR:120}] {\bf \textlabel{Display description}{FR:T120}}  \\
	...
	\item[\textlabel{/FR130/}{FR:130}] {\bf \textlabel{Load new games}{FR:T130}} \\
...
\begin{description}
  	\item[\textlabel{/FR140/}{FR:140}] {\bf \textlabel{Save games}{FR:T140}}  \\
  	A started and running game can be saved by clicking the `Menu' button in the navigation bar and selecting `Save'.
 	\item[\textlabel{/FR150/}{FR:150}] {\bf \textlabel{Load games}{FR:T150}}  \\
	...
	\item[\textlabel{/FR160/}{FR:160}] {\bf \textlabel{Pause games}{FR:T160}}  \\
	...
	\item[\textlabel{/FR170/}{FR:170}] {\bf \textlabel{Restart game}{FR:T170}}  \\
	...
	\item[\textlabel{/FR180/}{FR:180}] {\bf \textlabel{Undo move}{FR:T180}}  \\
	...
	\item[\textlabel{/FR190/}{FR:190}] {\bf \textlabel{Redo move}{FR:T190}} \\
	...
	\item[\textlabel{/FR200/}{FR:200}] {\bf \textlabel{Take screenshots}{FR:T200}} \\
...
\begin{description}
  	\item[\textlabel{/NFR010/}{NFR:010}] {\bf \textlabel{Simple usage}{NFR:T010}}  \\
	...
	\item[\textlabel{/NFR020/}{NFR:020}] {\bf \textlabel{Documentation in detail}{NFR:T020}} \\
...
\begin{description}
	\item[\textlabel{/NFR030/}{NFR:030}] {\bf \textlabel{Crashes}{NFR:T030}}  \\
	Games implemented with the Graphioli framework will not crash more often than once per 10.000 uses. \\
	\item[\textlabel{/NFR040/}{NFR:040}] {\bf \textlabel{Short loading time}{NFR:T040}} \\
	The loading time of the implemented games will be shorter than 5 seconds. \\
	\item[\textlabel{/NFR050/}{NFR:050}] {\bf \textlabel{Security}{NFR:T050}} \\

...
All algorithms worked as expected. They are covered up to almost 100\%.\par
...
We implemented unit tests during the implementation phase, resulting in a code coverage of 12.3\%.\par
A lot more unit test have been added since and by the end of the validation phase, we achieved a code coverage between 72.1\% and 98.6\%, depending on the packages and beat the number of 89.2\% of code coverage with unit tests, GUI tests and manual tests for all packages together.\par
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.85]{coverage_all.png}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.85]{coverage_unitTests.png}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.85]{coverage_sikuli.png}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.85]{coverage_controller.png}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.85]{coverage_gameExplorer.png}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.85]{coverage_model.png}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.85]{coverage_utils.png}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.85]{coverage_game.png}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.85]{coverage_view.png}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.85]{coverage_algorithms.png}

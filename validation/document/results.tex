...
A lot more unit test have been added since and by the end of the validation phase, we beat the number of 89\% \todo{Verify number after all tests are implemented} of code coverage with unit tests, GUI tests and manual tests for all packages together.\par
...
\todo{Insert more detailed table image}
...
\todo{Insert comparing images (unit tests only, GUI tests only, manual tests only, all together)}
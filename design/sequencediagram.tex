...
\end{figure}
\todo{Adjust pdf's empty margins to maximize figure 2 (doesn't fit on page nicely due to section headline).}
...
\end{figure}
\todo{Adjust pdf's empty margins to maximize figure 7.}
...
\end{figure}
\todo{Adjust pdf's empty margins to maximize figure 9.}
...
This class represents a \gls{vertex} used in the \graphcoloring \gls{game} by defining a \texttt{colorID} attribute that can be used by the graph coloring \gls{algorithm}s. \\

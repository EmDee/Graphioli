...
\begin{longtable}{Lp{10cm}}
	...
	& Draws this \texttt{SimpleVisualVertex} according to its color, stroke colorand stroke weight attributes. \\
	\hline
\end{longtable}
...
This class represents a Vertex used in the \texttt{Graph Coloring} game by defining a \texttt{colorID} attribute that can be used by the graph coloring algorithms. \\
...
This class represents a Vertex used in the \texttt{TwixT} game., which is displayed as either a red or blue tower, depending on the player it belongs to. \\

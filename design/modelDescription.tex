...
\begin{longtable}{Lp{10cm}}
	...
	& Returns true if this vertex is adjacent to the given vertex. \\
	\hline
\end{longtable}
...
This class represents a vertex and its visual representation. \\
...
\begin{longtable}{Lp{10cm}}
	...
	& Returns the color of this \texttt{SimpleVisualVertex}. \\
	\method{public int}{getStrokeWeight()}{svv:getStrokeWeight} \\
	& Returns the stroke weight of this \texttt{SimpleVisualVertex}. \\
	\method{public Color}{getStrokeColor()}{svv:getstrokecolor} \\
	& Returns the stroke color of this \texttt{SimpleVisualVertex}. \\
	\method{public boolean}{setColor(Color color)}{svv:setcolor} \\
	& Sets the color of this \texttt{SimpleVisualVertex}. \\
	\method{public boolean}{setStrokeWeight(int strokeWeight)}{svv:setstrokeweight} \\
	& Sets the stroke weight of this \texttt{SimpleVisualVertex}. \\
	\method{public boolean}{setStrokeColor(Color strokeColor)}{svv:setstrokecolor} \\
	& Sets the stroke color of this \texttt{SimpleVisualVertex}. \\
...
% Edge
\class{Edge}{edge}
This class represents a logical \texttt{edge}. \\
...
This class represents an edge and its visual representation.
...
This abstract class represents a \texttt{player}. \\

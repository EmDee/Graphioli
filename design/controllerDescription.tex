...
\begin{longtable}{Lp{10cm}}
	...
	& This method will be called on initialization of the \graphcoloring game. It will set up all parameters that are needed to start the game. \\
...
\begin{longtable}{Lp{10cm}}
	...
	& Generates the \ref{cls:gameboard} used to play the \twixt game. \\

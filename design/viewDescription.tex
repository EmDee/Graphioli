...
\begin{longtable}{Lp{10cm}}
	...
	& Redraws the graph displayed in the \ref{cls:graphcanvas}. \\ \hline
\end{longtable}
...
\begin{longtable}{Lp{10cm}}
	...
	& Adds a MenuItem to the options menu. \\ \hline
\end{longtable}

%CustomMenuItemListener
\class{CustomMenuItemListener}{custommenuitemlistener}

Listens to one specific MenuItem in the \ref{cls:menubar} and forwards it to the \ref{cls:viewmanager} if it is selected. \\
\begin{description}
	\item[All Implemented Interfaces] \hfill \\
